...
export function onMessage(message, context) {
  ...
  // ot_parameter_update backs c8y_ParameterUpdate). Each capability is a retained empty message
  // on te/device/<device>///cmd/<type>.
  const caps = context.config?.command_capabilities || "ot_write,ot_write_coil,ot_parameter_update";
